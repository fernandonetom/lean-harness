...
| 2 | Seed project memory | Seeding project memory |
| 3 | Graphify — build or verify | Checking graph |
| 4 | D1 — Seed files via graphify | Querying graph for seed files |
| 5 | Coverage check + user prompt | Evaluating graph coverage |
| 6 | Conditional research — web + deeper discovery | Researching unknowns |
| 7 | D2–D3 — Dependency + risk probes | Traversal and risk probes |
| 8 | Risk gate review + user prompt | Reviewing risk areas |
| 9 | Aggregate → write artifacts | Writing discovery and boundary |
| 10 | Report | Reporting |
