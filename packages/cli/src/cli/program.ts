...
export function buildProgram(): Command {
  ...
  program
    ...
    .option(
      "--local-plugin",
      "OpenCode: write the guardrail plugin as local files in .opencode/plugins/ instead of registering the npm-published @feneto/lh-opencode package (for offline/restricted environments)",
    )
