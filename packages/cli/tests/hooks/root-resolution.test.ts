...
// hosts/claude-code/hooks/ is a sibling workspace package, not part of packages/cli — this is an
// intentional test-only coupling (this test's real subject is addWorktree, imported above; the
// hook script itself lives in the Claude Code plugin package).
const hookPath = path.resolve(import.meta.dirname, "../../../../hosts/claude-code/hooks/pre-tool-use.js");
