...
- relevant task summaries in `.lh/features/<feature-id>-<slug>/task-summaries/` (bounded to immediately preceding task and direct task dependencies — Context for Next Task sections only, not full summary bodies)
