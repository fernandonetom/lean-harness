...
export async function installClaudeCodePack(
  ...
  const skillSubdirs = ["lh-do", "lh-spec", "lh-discover", "lh-plan", "lh-build", "lh-check", "lh-status", "lh-release"];
...
function createClaudeCodeSkillFiles(): SkillEntry[] {
  return [
    ...
    { subdir: "lh-release", content: createCCSkillRelease() },
  ];
}
...
function createCCSkillRelease(): string {
  return `---
name: lh-release
